...
entity UPG_Memory_Interface is
    port (
        clk        : in  STD_LOGIC;
        rst        : in  STD_LOGIC;
...
end UPG_Memory_Interface;

architecture Structural of UPG_Memory_Interface is
...
begin
    ...
    process (mem_rdata_i, mem_funct3_i, alu_res_s)
        variable byte_v : std_logic_vector(7 downto 0);
        variable half_v : std_logic_vector(15 downto 0);
    begin
        case alu_res_s(1 downto 0) is
            when "00" =>
                byte_v := mem_rdata_i(7 downto 0);
            when "01" =>
                byte_v := mem_rdata_i(15 downto 8);
            when "10" =>
                byte_v := mem_rdata_i(23 downto 16);
            when others =>
                byte_v := mem_rdata_i(31 downto 24);
        end case;

        if alu_res_s(1) = '0' then
            half_v := mem_rdata_i(15 downto 0);
        else
            half_v := mem_rdata_i(31 downto 16);
        end if;
